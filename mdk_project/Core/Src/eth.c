...
void PHY_Init(void)
{
    ...
    case LAN8742_STATUS_100MBITS_FULLDUPLEX:
        ...
        printf("LAN8740_STATUS_100MBITS_FULLDUPLEX \r\n");
        break;
    case LAN8742_STATUS_100MBITS_HALFDUPLEX:
        duplex = ETH_HALFDUPLEX_MODE;
        speed = ETH_SPEED_100M;
        
        printf("LAN8740_STATUS_100MBITS_HALFDUPLEX \r\n");
        break;
    case LAN8742_STATUS_10MBITS_FULLDUPLEX:
        duplex = ETH_FULLDUPLEX_MODE;
        speed = ETH_SPEED_10M;
        
        printf("LAN8740_STATUS_10MBITS_FULLDUPLEX \r\n");
        break;
    case LAN8742_STATUS_10MBITS_HALFDUPLEX:
        duplex = ETH_HALFDUPLEX_MODE;
        speed = ETH_SPEED_10M;
        
        printf("LAN8740_STATUS_10MBITS_HALFDUPLEX \r\n");
        break;
    default:
        duplex = ETH_FULLDUPLEX_MODE;
        speed = ETH_SPEED_100M;
